...
// // const someCallBack = (...args: any[]) => {
// //   //   console.log(`Event emited `, args);
// // };

// // eventBus.on("someEvent", someCallBack);

// // eventBus.emit("someEvent", "some", "data", "to", "process");

// // eventBus.off("someEvent", someCallBack);
